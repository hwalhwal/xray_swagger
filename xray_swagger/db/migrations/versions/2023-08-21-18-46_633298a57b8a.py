...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            ["settings_product.product_id", "settings_product.setting_param_name"],
        ),
        sa.PrimaryKeyConstraint("product_id", "setting_param_name", "version"),
    )
    op.create_index(
        "idx_settings_product_changelog",
        "settings_product_changelog",
        ["product_id", "setting_param_name", "version"],
        unique=True,
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index("idx_settings_product_changelog", table_name="settings_product_changelog")
